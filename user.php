                ...
                <div class="card-stats">
                  <div class="card-stats-title">Pesquisar Vaca
						...
						<form action="sessaovaca.php" method="POST">
							<input id="vaca" type="text" class="form-control" name="vaca">
						...
						<button onclick="window.location.href='<?php echo $url; ?>';" class="btn btn-primary btn-lg btn-block">QRCODE</button>
						</div>  
                 </div>    
                </div>
              </div>
